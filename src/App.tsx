...
function App() {
  ...
  useEffect(() => {
    const texts:any = document.querySelectorAll('h2')
    ...
    <main className='w-screen h-screen flex overflow-hidden'>
      ...
      <div className={`h-full overflow-hidden w-1/2 relative animateClip`} > 
        <div className="absolute h-full w-full flex flex-col justify-between bg-[rgba(0,0,0,0.4)] text-slate-200 z-[2]">
          ...
          <h2 className='transSplint exo2  bottom-8 text-[4rem] w-fit ml-auto mr-4'>#987</h2>
        </div>
      ...
      <div className="absolute h-full w-full flex flex-col justify-between bg-[rgba(0,0,0,0.4)] text-slate-200 z-[2]">
          ...
          <h2 className='transSplint exo2  bottom-8 text-[4rem] tracking-widest w-fit ml-auto mr-4'>#987</h2>
        </div>
